                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <label for="name" class="form-label">Nama Fasilitas <span>*</span></label>
                            <input type="text" class="form-control inputReset" id="name" name="name"
                                placeholder="Masukan Nama Fasilitas" required>
                        </div>
                        <div class="col-12 mb-2">
                            <label for="amount" class="form-label">Jumlah <span>*</span></label>
                            <input type="number" class="form-control inputReset" id="amount" name="amount"
